...
function renderResources(){
  const libraries=[['handbook/00-end-to-end.md',t('超大 LLM 训练：端到端总览')],['handbook/01-data-model-pretraining-design.md',t('数据、模型与预训练设计')],['handbook/02-distributed-pretraining-operations.md',t('分布式预训练与运行')],['handbook/03-posttraining-agent-rl-evaluation.md',t('后训练、Agent RL 与评估')],['handbook/04-marin-535b-live-case-study.md',t('Marin 535B：公开训练案例')],['lessons/01-one-token-to-update.md',t('首课：一枚 token 到一次更新')],['RESOURCE_ATLAS.md',t('扩展资源：课程、论文与工具')],['GLOSSARY.md',t('训练与系统共用术语')],['KNOWLEDGE_TREE.md',t('完整知识树')],['COVERAGE.md',t('知识覆盖、深度与缺口')]];
