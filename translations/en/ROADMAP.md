...
| [M12 Harnesses, tasks, and trajectories](curriculum/03-posttraining-and-agents.md#m12) | What did the model actually see, generate, and accomplish? | Harbor/Verifiers, Pi/SoL-Pi/DeepSeek Harness, Claude Code | Environment and scoring contracts, token trace with provenance |
