...
更新：2026-09-11。21 个项目已经克隆，初读笔记以 [sources.lock.json](sources.lock.json) 中的版本为准。
...
下表是原始登记索引；每项笔记含固定版本链接与具体文件入口。新读者按 ROADMAP 的 M00–M15 进入这些材料，不必依次通读 21 个仓库。
...
| 21 | [SoL-Pi](notes/repositories/sol-pi.md) | Harness 提效怎样接受正确性、证据与缓存成本的约束？ | 四机制对照、8 个真实成本函数场景、独立配对评测设计 |
